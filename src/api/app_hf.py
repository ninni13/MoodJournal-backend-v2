...
HF_REPO_ID = "ninni13/moodjournal-multimodal-emotion"
...
print("HF model directory:", HF_MODEL_DIR)

TEXT_MODEL_DIR = (
    HF_MODEL_DIR / "text_model"
)

SPEECH_MODEL_DIR = (
    HF_MODEL_DIR / "speech_model"
)

FUSION_MODEL_PATH = (
    HF_MODEL_DIR / "fusion_model.joblib"
)

TEXT_CONFIG_PATH = (
    HF_MODEL_DIR / "text_macbert.json"
)

SPEECH_CONFIG_PATH = (
    HF_MODEL_DIR / "speech_wavlm.json"
)
